...
namespace HybridWebSocket
{
    ...
    public static class WebSocketFactory
    {
        ...
        public delegate void OnMessageCallback(int instanceId, System.IntPtr dataPtr);
        ...
        public static void DelegateOnMessageEvent(int instanceId, System.IntPtr dataPtr)
        {
            ...
            if (instances.TryGetValue(instanceId, out instanceRef))
            {
                ...
                instanceRef.DelegateOnMessageEvent(data + "}");
            }
